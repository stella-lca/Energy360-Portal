...
// 		const CECONY_redir = `https://www.coned.com/accounts-billing/dashboard/billing-and-usage/share-my-data-connections/third-party-authorization?ThirdPartyId=${APPSETTING_GREENCONNECT_ID}&third_party_notify_uri=https://greenconnect-energy360-test.azurewebsites.net/api/notify`;
// 		const ORU_redir = `https://www.oru.com/accounts-billing/dashboard/billing-and-usage/share-my-data-connections/third-party-authorization?ThirdPartyId=${APPSETTING_GREENCONNECT_ID}&third_party_notify_uri=https://greenconnect-energy360-test.azurewebsites.net/api/notify`;
