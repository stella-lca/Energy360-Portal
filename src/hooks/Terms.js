      ...
      <Container>
        <div>
          <div className="texto">
            ...
            <p>
              <strong>LC Associates – Green Connect Entrepreneur Portal</strong>{" "}
              ...
              enhance the current Program, including the release of new tools
              and resources, shall be subject to the Terms of Service. Continued
              use of the Program after any such changes shall constitute your
              consent to such changes.
            </p>
            <p>
              Violation of any of the terms below will result in the termination
              of your Account. You agree to use the Green Connect Entrepreneur
              Portal at your own risk.
            </p>
            ...
            <p>
              ...
              jurisdiction over you, whether those laws, etc. are now in effect
              or later come into effect during the contract time you are a
              Program participant. Without limiting the foregoing obligation,
              you agree that as a condition of your participation in the Program
              you will comply with all applicable laws (federal, state or
            ...
            <p>
              ...
              reason, you will immediately cease use of&nbsp;all other materials
            ...
            <p>
              ...
              result in the deactivation or deletion of your Account or your
              access to your Account, and the forfeiture and relinquishment of
              all potential or to-be-paid commissions in your Account if they
              were earned through fraudulent, illegal, or overly aggressive,
            ...
            <p>
              ...
              In addition, we make no representation that the operation of the{" "}
              <strong>LC Associates – Green Connect Entrepreneur Portal</strong>
